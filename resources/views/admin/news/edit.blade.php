                ...
                <div class="control-group">
                  ...
                  <div class="control-group">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea class="span12 ckeditor m-wrap" name="short_desc_en" rows="3">{{$news->short_desc_en}}</textarea>
                      </div>
                    </div>
                  ...
                  <div class="controls">
                    <textarea class="span12 ckeditor m-wrap" name="short_desc_ar" rows="3">{{$news->short_desc_ar}}</textarea>
                  </div>
                </div>
								<div class="control-group">
									<label class="control-label">Details <span class="required">*</span></label>
									<div class="controls">
										<textarea class="span12 ckeditor m-wrap" name="details_en" rows="5">{{$news->details_en}}</textarea>
									</div>
								</div>
							...
							<div class="controls">
								<textarea class="span12 ckeditor m-wrap" name="details_ar" rows="5">{{$news->details_ar}}</textarea>
							</div>
						</div>
