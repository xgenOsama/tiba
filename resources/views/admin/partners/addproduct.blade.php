...
@section('content')
                ...
                {!! Form::open(['route'=>'add_product','files'=>'true']) !!}
                  ...
                  <div class="control-group">
  										...
  										<div class="controls">
  											<input type="text" name="title_en" class="span6 m-wrap tooltips" data-trigger="hover" data-original-title="Name in English">
  										</div>
  									</div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" name="title_ar" class="span6 m-wrap tooltips" data-trigger="hover" data-original-title="Name in Arabic">
                        </div>
                      </div>
