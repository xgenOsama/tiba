                    ...
                    <div class="control-group">
                      ...
                      <div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea class="span12 ckeditor m-wrap" name="add_desc_en" rows="3"></textarea>
											</div>
										</div>
										...
										<div class="controls">
											<textarea class="span12 ckeditor m-wrap" name="add_desc_ar" rows="3"></textarea>
										</div>
									</div>
									<div class="control-group">
									<label class="control-label">اضافه رابط <span class="required"></span></label>
									<div class="controls partener-link">
										<input type="text" name="links[]"  class="span6 m-wrap tooltips" data-trigger="hover" data-original-title="Link">
